    ...
    return (
        <>
            ...
            <div className="h-100 w-100">
                ...
                <div className="h-100 w-100"> {/* Here will be all the pricing plans per seat in a 100 seats plane */}
                    ...
                    <div className="w-auto h-100 d-flex justify-content-center align-items-center gap-5" id="cardPriceContainer">
                        <Card className="h-auto text-wrap cardClass" id="firstCard">
                            ...
                            <Card.Text className="fs-3 mx-3">En esta clase encontraras las siguientes caracteristicas:</Card.Text>
